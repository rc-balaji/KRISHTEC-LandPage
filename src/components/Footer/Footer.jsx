    ...
    <footer className="bg-gray-800 py-8 px-8 font-[sans-serif] tracking-wide mt-16">
      <div className="relative">
        <div className="bg-blue-600 gap-3 rounded-md flex items-center sm:px-12 max-sm:px-4 py-4 absolute top-[-66px] w-full">
          <h6 className="text-white sm:text-xl max-sm:text-sm font-semibold">Intership for students Provide Valuable, Hands-On Experience Opportunities....</h6>
          <button onClick={()=>{
            alert("Redirect to G Form")
          }} type='button' className="sm:px-4 max-sm:px-2 py-2 sm:text-sm max-sm:text-xs rounded-full text-blue-600 gap-2 bg-white ml-auto">
            Get Started
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
          <div>
            <h4 className="mt-5 text-xl font-semibold mb-6 text-white">About Us</h4>
            <p className="text-gray-400 text-base">
              Developer of IoT-based systems intended to solve environmental challenges and help in industrial and home automation. The company's products include remote monitoring solutions for air quality, water management, and energy efficiency.
            </p>
          </div>

          <div>
            <h4 className="mt-5 text-xl font-semibold mb-6 text-white">Opening Hours</h4>
            <ul className="space-y-4">
              <li className="text-gray-400 text-base">Monday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Tuesday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Wednesday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Thursday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Friday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Saturday: 10.00 am - 7.00 pm</li>
              <li className="text-gray-400 text-base">Sunday: Closed</li>
            </ul>
          </div>

          <div>
            <h4 className="mt-5 text-xl font-semibold mb-6 text-white">Contact Us</h4>
            <ul className="space-y-4">
              <li className="text-gray-400 text-base">Ist Floor, Sanhasa Square, Bharathi Park, 3rd Cross, Coimbatore-641043</li>
              <li className="text-gray-400 text-base">+91 9894954680</li>
              <li className="text-gray-400 text-base">+91 7825933039</li>
              <li className="text-gray-400 text-base">director@krishtec.co.in</li>
              <li className="text-gray-400 text-base">www.KrishTec.co.in</li>
            </ul>
          </div>

          <div>
            <h4 className="mt-5 text-xl font-semibold mb-6 text-white">Follow Us</h4>
            <ul className="flex items-center flex-wrap gap-y-3 space-x-6">
            {/* facebook */}
              <li><a href='https://www.facebook.com/krishtec/'>
              ...
              {/* LinkedIn */}
              <li><a href='https://www.linkedin.com/company/krishtec/?originalSubdomain=in' >
      ...
      <div className="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
        <p className='text-gray-400 text-base'>© 2022 All Rights Reserved.</p>
      </div>
    </footer>
  );
};
