        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
          <div>
            ...
            <p className="text-gray-400 text-base">
              Developer of IoT-based systems intended to solve environmental
              challenges and help in industrial and home automation. The
              company's products include remote monitoring solutions for air
              quality, water management, and energy efficiency.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="text-gray-400 text-base">
                Ist Floor, Sanhasa Square, Bharathi Park, 3rd Cross,
                Coimbatore-641043
              </li>
          ...
          <div>
            ...
            <ul className="flex items-center flex-wrap gap-y-3 space-x-6">
              {/* facebook */}
              <li>
                <a href="https://www.facebook.com/krishtec/">
                  <svg
              ...
              {/* LinkedIn */}
              <li>
                <a href="https://www.linkedin.com/company/krishtec/?originalSubdomain=in">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="inline w-6 h-6"
                    viewBox="0 0 176 176"
